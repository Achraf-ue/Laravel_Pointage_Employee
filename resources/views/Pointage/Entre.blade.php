        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{route('Pointage.Entre.Ajouter')}}" >
                            @csrf
                                ...
                                <button type="submit" class="btn btn-success waves-effect waves-light">Entre Employee - {{$date}}</button>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td>{{$Pointage_Entre->Date_Entre}}</td>
                                </tr>
                                @endforeach
                                </tbody>
                            </table>
